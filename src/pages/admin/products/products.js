...
async function addStock(productId, amount) {
    try {
        const btn = document.querySelector(`[data-product-id="${productId}"].add-stock-btn`);
        btn.disabled = true;
...
async function setStock(productId, amount) {
    try {
        const btn = document.querySelector(`[data-product-id="${productId}"].set-stock-btn`);
        btn.disabled = true;
