...
class UserManagement {
    ...
    private usersGridElement!: HTMLElement;
    private roleFilterElement!: HTMLSelectElement;
    private deleteModal!: HTMLElement;
    private userToDelete: IUser | null = null;
    ...
    constructor() {
        ...
        this.usersGridElement = document.getElementById('users-grid') as HTMLElement;
        this.roleFilterElement = document.getElementById('roleFilter') as HTMLSelectElement;
    ...
    private isLastAdmin(user: IUser): boolean {
        if (user.role !== 'admin') return false;
        const adminCount = this.users.filter(u => u.role === 'admin').length;
        return adminCount <= 1;
    }

    public showDeleteModal(userId: number): void {
    ...
    private updateStats(): void {
        ...
        if (adminsElement) adminsElement.textContent = stats.admins.toString();
        if (clientsElement) clientsElement.textContent = stats.clients.toString();
    }
